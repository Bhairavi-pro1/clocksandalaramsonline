            ...
            <div className="flex flex-col md:flex-row items-center gap-6 md:gap-12">
               <div className="flex-1 space-y-3 md:space-y-6 text-center md:text-left">
                  <div className="flex items-center justify-center md:justify-start gap-3">
                     <div className="px-3 py-1 rounded-full bg-white/5 border border-primary/30 text-primary text-[9px] md:text-[10px] font-black uppercase tracking-widest">
                       Global Schedule
                     </div>
               ...
               <div className="relative flex items-center bg-slate-200/50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl md:rounded-2xl px-4 md:px-6 h-10 md:h-14 backdrop-blur-xl focus-within:border-primary/50 transition-all">
                  ...
                  {searchTerm && (
                    <button 
                      ...
                      className="p-1 hover:bg-slate-300/50 dark:hover:bg-white/10 rounded-full transition-colors"
            ...
            <div className="flex items-center gap-3 md:gap-6 group">
              <div className="flex items-baseline gap-1.5 md:gap-2">
                ...
                <span className="text-primary font-black uppercase text-[9px] sm:text-xs tracking-widest whitespace-nowrap">
                  <span className="hidden sm:inline">(In {group.daysRemaining} days)</span>
        ...
        {groupedChanges.length > visibleGroups && (
          <div className="flex justify-center pt-4 pb-8">
            <button 
              ...
              className="px-6 py-3 rounded-full bg-white/5 border border-primary/30 hover:bg-primary hover:text-white text-primary text-[10px] font-black uppercase tracking-wider transition-all cursor-pointer flex-shrink-0 flex items-center gap-2"
            >
              Load More Dates
            </button>
          </div>
