         ...
         <div className="relative z-10 space-y-4 md:space-y-10">
            <div className="flex flex-col md:flex-row items-center gap-6 md:gap-12">
               <div className="flex-1 space-y-3 md:space-y-6 text-center md:text-left">
                  ...
                  <h1 className="text-2xl md:text-6xl font-black text-white tracking-tight leading-none italic">
        ...
        {groupedChanges.length > visibleGroups && (
          <div className="flex justify-center pt-4 pb-8">
            <button 
              ...
              className="px-6 py-3 rounded-full bg-primary/10 border border-primary/20 hover:bg-primary/20 text-primary text-[10px] font-black uppercase tracking-wider transition-all cursor-pointer flex-shrink-0 flex items-center gap-2"
            >
              Load More Dates
            </button>
          </div>
