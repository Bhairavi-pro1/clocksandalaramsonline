    ...
    <>
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-[60] bg-[#0a0118]/80 backdrop-blur-2xl border-b border-white/10 py-3 px-6 shadow-2xl flex items-center justify-between">
        ...
        <button 
          ...
          className="p-3 bg-white/5 rounded-xl border border-white/10 hover:bg-white/10 transition-all active:scale-90 cursor-pointer"
        >
      ...
      <aside className={cn(
        ...
        <div className="flex justify-end p-6">
           <button 
            ...
            className="p-3 bg-white/5 rounded-xl border border-white/10 hover:bg-red-500/20 hover:border-red-500/40 transition-all active:scale-90 cursor-pointer"
           >
