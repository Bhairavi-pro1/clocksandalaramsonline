        ...
        >
          ...
          {isFullscreen && (
            <div className="absolute top-8 left-0 right-0 flex flex-col items-center z-20 pointer-events-none">
              <h1 className="text-white/70 text-[10px] md:text-sm font-black uppercase tracking-[0.5em] mb-2 drop-shadow-xl select-none">
              ...
              <div className="w-full max-w-4xl px-4 animate-in slide-in-from-bottom-2 duration-1000">
                <div className="relative">
                  ...
                  {/* <div className="text-center mt-2 opacity-20">
                    <span className="text-[7px] text-white uppercase tracking-[0.3em] font-black">ADVERTISEMENT</span>
                  </div> */}
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 mt-10">
              ...
              <section className="lg:col-span-2 space-y-6">
                <div className="flex items-center gap-4 bg-primary/5 p-5 rounded-2xl border border-primary/10">
                  ...
                  <h2 className="text-xl font-bold text-white">About the {holiday.name} Tracker</h2>
                </div>
